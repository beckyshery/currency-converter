...
const ConverterForm = () => {
    ...
    const getExchangeRate = async () => {
        ...
        const API_URL = https//v6.exchangerate-api.com/v6/6d2243d5f75548f79337457951b376a9-spk6pt/pair/USD/KSH
    ...
    return (
        <form className="converter-form" onSubmit={handleFormSubmit}>
            ...
            <button type="submit" className="submit-button">Get Exchange Rate
            </button>
            <p className="exchange-rate-results">1 USD = 126 KES</p>
        </form>
    );
};
